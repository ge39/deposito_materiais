...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Procure por algo parecido com isso no seu script principal:
    // async function finalizarVenda(e) {
    //     if(e) e.preventDefault();
        
    //     // ... código existente que valida valores e monta o FormData/JSON ...

    //     try {
    //         const response = await fetch("{{ route('pdv.finalizar') }}", { // ou sua rota de envio
    //             method: 'POST',
    ...
    //             // =====================================================
    //             // 1. ROTINA DE IMPRESSÃO EXISTENTE (Exemplo comum)
    //             // =====================================================
    //             if (typeof window.print === 'function') {
    //                 window.print(); // O navegador congela aqui até fechar a janela de impressão
    //             }

    //             // =====================================================
    //             // 2. GATILHO DA SANGRIA DISPARADO LOGO APÓS A IMPRESSÃO
    //             // =====================================================
    //             // Usamos um pequeno setTimeout para dar tempo do modal de fechamento sumir 
    //             // e liberar a abertura do novo modal de Sangria de forma limpa.
    //             setTimeout(() => {
    //                 abrirSangriaAutomatico();
    //             }, 400);

    //         }

    //         function abrirSangriaAutomatico() {
    //             // 1. Primeiro removemos qualquer resíduo/película cinza de modais anteriores
    //             document.body.classList.remove('modal-open');
    //             document.body.style.overflow = '';
    //             document.body.style.paddingRight = '';
    //             document.querySelectorAll('.modal-backdrop').forEach(b => b.remove());

    //             // 2. Localiza o elemento do modal de sangria
    //             const modalSangriaEl = document.getElementById('modalSangria') || document.querySelector('.modal-sangria');
                
    //             if (modalSangriaEl) {
    //                 if (typeof bootstrap !== 'undefined') {
    //                     // Cria a instância de forma limpa e exibe
    //                     const modalSangria = bootstrap.Modal.getOrCreateInstance(modalSangriaEl, {
    //                         backdrop: 'static', // Obriga o operador a interagir com o modal
    //                         keyboard: true
    //                     });
    //                     modalSangria.show();

    //                     // 3. Puxa o foco automaticamente para o input de valor da sangria após abrir
    //                     modalSangriaEl.addEventListener('shown.bs.modal', function () {
    //                         setTimeout(() => {
    //                             const inputValor = modalSangriaEl.querySelector('input[type="number"]') || document.getElementById('valor_sangria');
    //                             if (inputValor) inputValor.focus();
    //                         }, 100);
    //                     }, { once: true }); // Executa apenas uma vez por abertura
    //                 }
    //             } else {
    //                 console.log("⚠ [DEBUG] O modal de Sangria não foi encontrado no DOM do PDV.");
    //             }
    //         }
