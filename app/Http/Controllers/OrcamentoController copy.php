 ...
 */
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'produtos.*.quantidade_estoque' => 'required|numeric|min:1',
        ...
        DB::transaction(function () use ($request) {
            ...
            foreach ($request->produtos as $itemReq) {
                ...
                $quantidadeDesejada = $itemReq['quantidade_solicitada'];
                ...
                ItemOrcamento::create([
                    ...
                    'lote_id'           => $loteId,
                    'quantidade_solicitada'  => $quantidadeDesejada,
   ...
   public function update(Request $request, $id)
    {
        ...
        DB::transaction(function () use ($request, $orcamento) {
            ...
            foreach ($request->produtos as $produtoReq) {
                ...
                $quantidadeDesejada = $produtoReq['quantidade_solicitada'];
     ...
     public function aprovar($id)
    {
        ...
        try {
            ...
            foreach ($orcamento->itens as $item) {
                ...
                $quantidadeSolicitada = (float) $item->quantidade_solicitada;
            ...
            return back()->with('success', 'Orçamento '. $orcamento->id . ' aprovado com sucesso!');
