...
class Caixa extends Model
{
    ...
    // {
    //     // 1️⃣ Abertura do caixa
    //     $abertura = $this->movimentacoes()
    //         ->where('tipo', 'abertura')
    //         ->sum('valor');

    //     // 2️⃣ Total vendido em dinheiro
    ...
    //     // 3️⃣ Total de sangrias
    //     $totalSangrias = $this->sangrias()
    //         ->sum('valor');

    //     return $abertura + $totalVendasDinheiro - $totalSangrias;
    // }
