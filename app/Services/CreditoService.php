...
class CreditoService
{
    ...
    {
        $saldoAtual = $this->saldoDevedor($cliente);

        return ($saldoAtual + $valorNovaVenda) <= $cliente->limite_credito;
    }
    ...
    public function validarCredito(Cliente $cliente, float $valorNovaVenda, array $pagamentos = []): array
    {
        ...
        if ($cliente->tipo === 'Venda Balcao' || 'VENDA BALCAO') {
