...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row g-3 mb-4 p-3 bg-light rounded border">
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" class="form-control calc-trigger" id="preco_compra_atual" name="preco_compra_atual" value="<?php echo e(old('preco_compra_atual', '0.00')); ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="custo_frete_unidade" class="form-label">Frete Rateado/Unid. (R$)</label>
                        <input type="number" step="0.01" class="form-control calc-trigger" id="custo_frete_unidade" name="custo_frete_unidade" value="<?php echo e(old('custo_frete_unidade', '0.00')); ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="custo_imposto_entrada" class="form-label">Imposto Entrada/ST (R$)</label>
                        <input type="number" step="0.01" class="form-control calc-trigger" id="custo_imposto_entrada" name="custo_imposto_entrada" value="<?php echo e(old('custo_imposto_entrada', '0.00')); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <input type="number" step="0.01" class="form-control calc-trigger" id="percentual_imposto_saida" name="percentual_imposto_saida" value="<?php echo e(old('percentual_imposto_saida', '0.00')); ?>">
                    </div>
                    <div class="col-md-4 mt-3">
                        <label for="percentual_comissao" class="form-label">Comissão do Vendedor (%)</label>
                        <input type="number" step="0.01" class="form-control calc-trigger" id="percentual_comissao" name="percentual_comissao" value="<?php echo e(old('percentual_comissao', '0.00')); ?>">
                    </div>
                    <div class="col-md-4 mt-3">
                        <label for="percentual_taxa_cartao" class="form-label">Taxa Administrativa Cartão (%)</label>
                        <input type="number" step="0.01" class="form-control calc-trigger" id="percentual_taxa_cartao" name="percentual_taxa_cartao" value="<?php echo e(old('percentual_taxa_cartao', '0.00')); ?>">
                    </div>
                </div>
                        ...
                        <div class="card border-primary h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="mb-2">
                                    ...
                                    <input type="number" step="0.01" class="form-control calc-trigger" id="markup_1" name="markup_1" value="<?php echo e(old('markup_1', '0.00')); ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="desconto_max_1" class="form-label mb-1">Limite Desconto (%)</label>
                                    <input type="number" step="0.01" class="form-control calc-trigger" id="desconto_max_1" name="desconto_max_1" value="<?php echo e(old('desconto_max_1', '0.00')); ?>">
                                </div>
                                <div>
                                    <label for="preco_venda" class="form-label mb-1 fw-bold text-primary">Preço de Venda (R$)</label>
                                    <input type="number" step="0.01" class="form-control fw-bold border-primary text-primary" id="preco_venda" name="preco_venda" value="<?php echo e(old('preco_venda', '0.00')); ?>">
                                </div>
                            </div>
                        </div>
                    </div> 
                        ...
                        <div class="card border-info h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="mb-2">
                                    ...
                                    <input type="number" step="0.01" class="form-control calc-trigger" id="markup_2" name="markup_2" value="<?php echo e(old('markup_2', '0.00')); ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="desconto_max_2" class="form-label mb-1">Limite Desconto (%)</label>
                                    <input type="number" step="0.01" class="form-control calc-trigger" id="desconto_max_2" name="desconto_max_2" value="<?php echo e(old('desconto_max_2', '0.00')); ?>">
                                </div>
                                <div>
                                    <label for="preco_venda_2" class="form-label mb-1 fw-bold text-info">Preço de Venda 2 (R$)</label>
                                    <input type="number" step="0.01" class="form-control fw-bold border-info text-info" id="preco_venda_2" name="preco_venda_2" value="<?php echo e(old('preco_venda_2', '0.00')); ?>">
                                </div>
                            </div>
                        </div>
                    </div> 
                        ...
                        <div class="card border-success h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="mb-2">
                                    ...
                                    <input type="number" step="0.01" class="form-control calc-trigger" id="markup_3" name="markup_3" value="<?php echo e(old('markup_3', '0.00')); ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="desconto_max_3" class="form-label mb-1">Limite Desconto (%)</label>
                                    <input type="number" step="0.01" class="form-control calc-trigger" id="desconto_max_3" name="desconto_max_3" value="<?php echo e(old('desconto_max_3', '0.00')); ?>">
                                </div>
                                <div>
                                    <label for="preco_venda_3" class="form-label mb-1 fw-bold text-success">Preço de Venda 3 (R$)</label>
                                    <input type="number" step="0.01" class="form-control fw-bold border-success text-success" id="preco_venda_3" name="preco_venda_3" value="<?php echo e(old('preco_venda_3', '0.00')); ?>">
                                </div>
                            </div>
                        </div>
                    </div> 
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="localizacao_estoque" name="localizacao_estoque" placeholder="Ex: Corredor B - Prateleira 4" value="<?php echo e(old('localizacao_estoque')); ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="peso" class="form-label">Peso (kg)</label>
                        <input type="number" step="0.01" class="form-control" id="peso" name="peso" value="<?php echo e(old('peso', '0.00')); ?>">
                    </div>

                    <div class="col-md-2">
                        <label for="largura" class="form-label">Largura (cm)</label>
                        <input type="number" step="0.01" class="form-control" id="largura" name="largura" value="<?php echo e(old('largura', '0.00')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label for="altura" class="form-label">Altura (cm)</label>
                        <input type="number" step="0.01" class="form-control" id="altura" name="altura" value="<?php echo e(old('altura', '0.00')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label for="profundidade" class="form-label">Profundidade (cm)</label>
                        <input type="number" step="0.01" class="form-control" id="profundidade" name="profundidade" value="<?php echo e(old('profundidade', '0.00')); ?>">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="ativo">Produto Ativo para Vendas</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="em_promocao" name="em_promocao" value="1">
                            <label class="form-check-label" for="em_promocao">Destacar em Promoção</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="controla_validade" name="controla_validade" value="1" checked onchange="toggleValidade(this)">
                            <label class="form-check-label" for="controla_validade">Controlar Validade</label>
                        </div>
                    </div>
                    <div class="col-md-3" id="validade_container">
                        <label for="validade_produto" class="form-label mb-1">Data de Validade</label>
                        <input type="date" class="form-control form-control-sm" id="validade_produto" name="validade_produto">
                    </div>
                </div>
