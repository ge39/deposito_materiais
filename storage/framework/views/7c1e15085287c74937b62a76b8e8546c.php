...
<div class="container">
    <h1>Detalhes do Produto 
        <span class="text-primary">- <?php echo e($produto->nome); ?></span>
    </h1>
    ...
    <div class="row" style="border:1px solid #ddd; padding:15px; border-radius:5px; background-color:#f9f9f9;">
        ...
        <div class="col-md-4">
            ...
            <div class="mb-3"><strong>Descrição:</strong> <?php echo e($produto->descricao ?? '-'); ?></div>
            ...
            <div class="mb-3 text-primary"><strong>Preço médio de compra:</strong> R$ <?php echo e(number_format($produto->preco_medio_compra, 2, ',', '.')); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\deposito_materiais\resources\views/produtos/show.blade.php ENDPATH**/ ?>