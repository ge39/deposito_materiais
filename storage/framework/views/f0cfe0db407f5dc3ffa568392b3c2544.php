...
<div class="container mt-4">
    <div class="card border-dark mx-auto" style="max-width: 400px;">
        <div class="card-body text-center" style="font-family: monospace; font-size: 18px;">
...
<style>
    @media print {
        /* Oculta tudo que está no layout do sistema */
        body * { 
            visibility: hidden; 
        }
        /* Exibe apenas o card do cupom */
        .card, .card * { 
            visibility: visible; 
        }
        .card { 
            ...
            top: 0; 
            width: 100%; 
            border: none !important; /* Remove bordas na impressão real */
            box-shadow: none !important;
        }
        /* Esconde o botão para não sair impresso no papel */
        .btn { 
            display: none !important; 
        }
        /* Remove margens do navegador e cabeçalhos padrão (Data/URL na folha) */
        @page {
            margin: 0;
        }
        body {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\deposito_materiais\resources\views/pdv/sangria_impressao.blade.php ENDPATH**/ ?>