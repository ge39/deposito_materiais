...
<div class="container">
    ...
    <span class="text-muted d-block mb-4">Código: #<?php echo e($orcamento->codigo_orcamento); ?></span>
                    ...
                    <?php $__currentLoopData = $oldProdutos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $oldItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row align-items-center mb-2 item-row border-bottom pb-2">
                            ...
                            <div class="col-md-1 fw-bold text-dark">
                                <div class="precoLabel">R$ <?php echo e(number_format($oldItem['preco_unitario'], 2, ',', '.')); ?></div>
                            ...
                            <div class="col-md-1 fw-bold text-dark subtotal">
                                <span class="subtotalLabel"><?php echo e(number_format($oldItem['quantidade'] * $oldItem['preco_unitario'], 2, ',', '.')); ?></span>
                            </div>
                                ...
                                <div class="p-3 border rounded bg-light mb-3 shadow-sm text-start">
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-6 d-flex justify-content-between align-items-center border-end pe-3">
                                            ...
                                            <span class="fs-5 fw-bold text-dark">R$ <span id="totalBruto"><?php echo e(number_format($totalBrutoReal + $orcamento->itens->sum('valor_desconto'), 2, ',', '.')); ?></span></span>
                                        </div>
                                        ...
                                        <div class="col-6 d-flex justify-content-between align-items-center ps-3">
                                            ...
                                            <div style="width: 80px;">
                                                <input type="number" name="desconto_global" id="descontoGlobal" 
                                                    ...
                                                    value="<?php echo e($descontoPercentualSalvo); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2 text-muted small px-1">
                                        ...
                                        <span>R$ <span id="totalDesconto"><?php echo e(number_format($totalDescontoReal, 2, ',', '.')); ?></span></span>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center px-1">
                                        ...
                                        <span class="fw-bold text-success fs-4">R$ <span id="totalComDesconto"><?php echo e(number_format($orcamento->total, 2, ',', '.')); ?></span></span>
                                    </div>
