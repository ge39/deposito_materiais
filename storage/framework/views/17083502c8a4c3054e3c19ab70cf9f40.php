    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body p-0">
            ...
            <?php else: ?>
                            ...
                            <?php if($ultimoBackup): ?>
                                <tr>
                                    <td>
                                        ...
                                        <strong><?php echo e($ultimoBackup['nome']); ?></strong>
                                    </td>
                                    <td class="text-center"><?php echo e($ultimoBackup['data']); ?></td>
                                    <td class="text-center"><?php echo e($ultimoBackup['hora']); ?></td>
                                    <td class="text-end"><?php echo e($ultimoBackup['tamanho']); ?></td>
                                    <td class="text-center">
                                        <span class="badge bg-secondary">Completo</span>
                                    </td>
                                    <td class="text-center">
                                        <?php if($ultimoBackup['valido']): ?>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('backups.download', $ultimoBackup['nome'])); ?>"
                                        ...
                                        <form action="<?php echo e(route('backups.restaurar')); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="arquivo" value="<?php echo e($ultimoBackup['nome']); ?>">
                                            <button type="submit"
                                        ...
                                        <form action="<?php echo e(route('backups.destroy', $ultimoBackup['nome'])); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                ...
                <?php if($historicoBackups->isNotEmpty()): ?>
                        ...
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed bg-light py-2 fw-bold"
                                    ...
                                    Histórico de backups anteriores (<?php echo e($historicoBackups->count()); ?>)
                                </button>
                            </h2>
                                ...
                                <div class="accordion-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-sm table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $historicoBackups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                            <i class="bi bi-file-earmark-zip text-warning me-2"></i>
    ...
    <div class="card shadow-sm mt-3">
        ...
        <div class="card-body p-0">
            ...
            <?php else: ?>
                    ...
                    <table class="table table-sm table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php if($ultimoLog): ?>
                                <tr>
                                    <td>
                                        <strong><?php echo e($ultimoLog->acao); ?></strong>
                                    </td>

                                    <td><?php echo e($ultimoLog->arquivo ?? '-'); ?></td>

                                    <td class="text-center">
                                        <?php if($ultimoLog->status === 'sucesso'): ?>
                                            <span class="badge bg-success">Sucesso</span>
                                        <?php elseif($ultimoLog->status === 'erro'): ?>
                                    ...
                                    <td class="text-end">
                                        <?php echo e(number_format(($ultimoLog->tamanho_bytes ?? 0) / 1024 / 1024, 2, ',', '.')); ?> MB
                                    </td>

                                    <td class="text-center">
                                        <?php echo e($ultimoLog->duracao_ms ? number_format($ultimoLog->duracao_ms / 1000, 2, ',', '.') . 's' : '-'); ?>

                                    </td>

                                    <td>
                                        <small><?php echo e($ultimoLog->mensagem ?? '-'); ?></small>
                                    </td>

                                    <td class="text-center">
                                        <?php echo e(optional($ultimoLog->created_at)->format('d/m/Y H:i')); ?>
                ...
                <?php if($historicoLogs->isNotEmpty()): ?>
                        ...
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed bg-light py-2 fw-bold"
                                    ...
                                    <i class="bi bi-clock-history me-2"></i>
                                    Histórico de operações anteriores (<?php echo e($historicoLogs->count()); ?>)
                                </button>
                            </h2>
                                ...
                                <div class="accordion-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-sm table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $historicoLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
