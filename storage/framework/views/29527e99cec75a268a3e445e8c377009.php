    ...
    <div class="border rounded overflow-hidden">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="d-flex align-items-center border-bottom p-2
                <?php echo e($loop->even ? 'bg-light' : 'bg-white'); ?> hover-row"
                style="font-size: 14px;">

                <div style="width:70px">000<?php echo e($produto->id); ?></div>

                <div style="width:180px"><?php echo e($produto->nome); ?></div>
                ...
                <div style="width:100px">
                    <?php echo e($produto->unidadeMedida->nome ?? '-'); ?>
                ...
                <div style="width:110px">
                    <?php echo e($produto->marca->nome ?? '-'); ?>

                </div>

                <div style="width:110px">
                    <?php echo e($produto->fornecedor->nome ?? '-'); ?>
                ...
                <div class="d-flex gap-1">
                    ...
                    <?php if(optional(auth()->user())->nivel_acesso == 'admin'
                        ...
                        <form action="<?php echo e(route('produtos.desativar', $produto->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
