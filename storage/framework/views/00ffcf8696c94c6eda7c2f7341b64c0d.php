    ...
    <form action="<?php echo e(route('produtos.update', $produto->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-2 p-2 bg-white rounded">
            <div class="col-md-3 mb-2 mb-md-0">
                ...
                <input type="number" class="form-control text-muted" id="quantidade_estoque" value="<?php echo e($produto->quantidade_estoque); ?>" disabled>
            </div>
            <div class="col-md-3 mb-2 mb-md-0">
                <label for="estoque_minimo" class="form-label">Estoque Mínimo</label>
                <input type="number" class="form-control text-muted" id="estoque_minimo" value="<?php echo e($produto->estoque_minimo); ?>" disabled>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2 mb-2 mb-md-0">
                    ...
                    <input type="number" step="0.01" class="form-control text-muted" id="preco_custo" value="<?php echo e($produto->preco_custo); ?>" disabled>
                </div>
            <div class="col-md-2">
