...
<div class="container-fluid px-2 my-4 text-dark">
    <div class="card shadow-sm bg-light text-dark fw-bold">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">📦 Editar Produto - <?php echo e($produto->nome ?? "Não disponivel"); ?></h5>
...
unset($__errorArgs, $__bag); ?>" id="nome" name="nome" value="<?php echo e(old('nome', $produto->nome)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="sku" name="sku" value="<?php echo e(old('sku', $produto->sku)); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="categoria_id" name="categoria_id" required>
                            ...
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>"  <?php echo e(old('categoria_id', $produto->categoria_id ?? '') == $cat->id ? 'selected' : ''); ?>>
                                <?php echo e($cat->nome); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="fornecedor_id" name="fornecedor_id" required>
                           ...
                           <?php $__currentLoopData = $fornecedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($forn->id); ?>"
                                    <?php echo e(old('fornecedor_id', $produto->fornecedor_id ?? '') == $forn->id ? 'selected' : ''); ?>>
                                    <?php echo e($forn->nome); ?>
                ...
                <div class="row g-3 mb-4 p-3 bg-light rounded border">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="custo_frete_unidade" name="custo_frete_unidade"  value="<?php echo e(old('custo_frete_unidade', $produto->custo_frete_unidade ?? '0.00')); ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="custo_imposto_entrada" class="form-label">Imposto Entrada/ST (R$)</label>
                        <input type="number" min="0" min="0"  step="0.01" class="form-control calc-trigger" id="custo_imposto_entrada" name="custo_imposto_entrada" value="<?php echo e(old('custo_imposto_entrada', $produto->custo_imposto_entrada ?? '0.00')); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="percentual_comissao" name="percentual_comissao" value="<?php echo e(old('percentual_comissao',$produto->percentual_comissao ?? '0.00')); ?>">
                    </div>
                    <div class="col-md-4 mt-3">
                        <label for="percentual_taxa_cartao" class="form-label">Taxa Administrativa Cartão (%)</label>
                        <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="percentual_taxa_cartao" name="percentual_taxa_cartao" value="<?php echo e(old('percentual_taxa_cartao',$produto->percentual_taxa_cartao ?? '0.00')); ?>">
                    </div>
                </div>
                        ...
                        <div class="card border-primary h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="mb-2">
                                    ...
                                    <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="markup_1" name="markup_1" value="<?php echo e(old('markup_1', $produto->markup_1 ?? '0.00')); ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="desconto_max_1" class="form-label mb-1">Limite Desconto (%)</label>
                                    <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="desconto_max_1" name="desconto_max_1" value="<?php echo e(old('desconto_max_1',$produto->desconto_max_1 ?? '0.00')); ?>">
                                </div>
                                <div>
                                    <label for="preco_venda" class="form-label mb-1 fw-bold text-primary">Preço de Venda (R$)</label>
                                    <input type="number" min="0"  step="0.01" class="form-control fw-bold border-primary text-primary" id="preco_venda" name="preco_venda" value="<?php echo e(old('preco_venda',$produto->preco_venda ?? '0.00')); ?>">
                                </div>
                            </div>
                        </div>
                    </div> 
                        ...
                        <div class="card border-info h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="mb-2">
                                    ...
                                    <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="markup_2" name="markup_2" value="<?php echo e(old('markup_2',$produto->markup_2 ?? '0.00')); ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="desconto_max_2" class="form-label mb-1">Limite Desconto (%)</label>
                                    <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="desconto_max_2" name="desconto_max_2" value="<?php echo e(old('desconto_max_2',$produto->desconto_max_2 ?? '0.00')); ?>">
                                </div>
                                <div>
                                    <label for="preco_venda_2" class="form-label mb-1 fw-bold text-info">Preço de Venda 2 (R$)</label>
                                    <input type="number" min="0"  step="0.01" class="form-control fw-bold border-info text-info" id="preco_venda_2" name="preco_venda_2" value="<?php echo e(old('preco_venda_2',$produto->preco_venda_2 ?? '0.00')); ?>">
                                </div>
                            </div>
                        </div>
                    </div> 
                        ...
                        <div class="card border-success h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="mb-2">
                                    ...
                                    <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="markup_3" name="markup_3" value="<?php echo e(old('markup_3',$produto->markup_3 ?? '0.00')); ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="desconto_max_3" class="form-label mb-1">Limite Desconto (%)</label>
                                    <input type="number" min="0"  step="0.01" class="form-control calc-trigger" id="desconto_max_3" name="desconto_max_3" value="<?php echo e(old('desconto_max_3',$produto->desconto_max_3 ?? '0.00')); ?>">
                                </div>
                                <div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-3">
                        ...
                        <input type="number" min="0" class="form-control" id="quantidade_estoque" name="quantidade_estoque" value="<?php echo e(old('quantidade_estoque',$produto->quantidade_estoque ?? 0)); ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="estoque_minimo" class="form-label">Estoque Mínimo</label>
                        <input type="number"  min="0" class="form-control" id="estoque_minimo" name="estoque_minimo" value="<?php echo e($produto->estoque_minimo ?? 0); ?>"required>
                    </div>
                    <div class="col-md-3">
                        <label for="localizacao_estoque" class="form-label">Localização no Depósito</label>
                        <input type="text" class="form-control" id="localizacao_estoque" name="localizacao_estoque" placeholder="Ex: Corredor B - Prateleira 4" value="<?php echo e(old('localizacao_estoque',$produto->localizacao_estoque ?? '')); ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="peso" class="form-label">Peso (kg)</label>
                        <input type="number" min="0"  step="0.01" class="form-control" id="peso" name="peso" value="<?php echo e(old('peso', $produto->peso ?? '0.00')); ?>">
                    </div>

                    <div class="col-md-2">
                        <label for="largura" class="form-label">Largura (cm)</label>
                        <input type="number" min="0"  step="0.01" class="form-control" id="largura" name="largura" value="<?php echo e(old('largura', $produto->largura ?? '0.00')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label for="altura" class="form-label">Altura (cm)</label>
                        <input type="number" min="0"  step="0.01" class="form-control" id="altura" name="altura" value="<?php echo e(old('altura',$produto->altura ?? '0.00')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label for="profundidade" class="form-label">Profundidade (cm)</label>
                        <input type="number" min="0"  step="0.01" class="form-control" id="profundidade" name="profundidade" value="<?php echo e(old('profundidade', $produto->profundidade ?? '0.00')); ?>">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="ncm" name="ncm" maxlength="8" value="<?php echo e(old('ncm',$produto->ncm ?? '0')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label for="cest" class="form-label">CEST</label>
                        <input type="text" class="form-control" id="cest" name="cest" maxlength="7" value="<?php echo e(old('cest', $produto->cest ?? '0')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label for="cfop" class="form-label">CFOP Padrão</label>
                        <input type="text" class="form-control" id="cfop" name="cfop" maxlength="4" value="<?php echo e(old('cfop', $produto->cfop ?? '0')); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="origem" name="origem">
                            <option value="0" <?php echo e(old('origem', $produto->origem ?? 0) == 0 ? 'selected' : ''); ?>>
                                0 - Nacional
                            </option>

                            <option value="1" <?php echo e(old('origem', $produto->origem ?? 0) == 1 ? 'selected' : ''); ?>>
                                1 - Estrangeira - Importação Direta
                            </option>

                            <option value="2" <?php echo e(old('origem', $produto->origem ?? 0) == 2 ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="descricao" name="descricao" rows="2"><?php echo e(old('descricao', $produto->descricao ?? 'sem descricao')); ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input"
                                ...
                                value="1"
                                <?php echo e(old('controla_validade', $produto->controla_validade ?? false) ? 'checked' : ''); ?>
                   ...
                   <div class="col-md-3" id="validade_container">
                        ...
                        <input type="date"
                            ...
                            value="<?php echo e(old('validade_produto', isset($produto) && $produto->validade_produto ? $produto->validade_produto->format('Y-m-d') : '')); ?>">
                    </div>
                </div>
