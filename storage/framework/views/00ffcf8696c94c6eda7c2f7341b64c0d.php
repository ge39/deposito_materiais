...
<div class="container pt-4" style="border:1px solid #ddd; padding:15px; border-radius:5px; background-color:#f9f9f9;">
    <h1 class="mb-3 text-primary">Editar Produto -  <?php echo e(old('descricao', $produto->descricao)); ?></h1>
...
<div class="row mb-2 p-2 bg-white rounded">
    ...
    <div class="col-md-3 mb-2 mb-md-0">
        ...
        <input type="number" class="form-control text-muted" 
               ...
               value="<?php echo e($produto->lotes->sum('quantidade_disponivel')); ?>" required>
    </div>
            ...
            <div class="col-md-4 mb-2 mb-md-0 text-center">
                ...
                <input type="file" class="form-control mb-1" id="imagem" name="imagem" accept="image/*" onchange="previewImage(event)">
                    <img id="imagemPreview"
                        src="<?php echo e(!empty($produto->imagem)
                                ? asset($produto->imagem)
                                : asset('image/produto-sem-imagem.png')); ?>"
                        onerror="this.src='<?php echo e(asset('image/produtos/produto-sem-imagem.PNG')); ?>'"
                        alt="Prévia"
