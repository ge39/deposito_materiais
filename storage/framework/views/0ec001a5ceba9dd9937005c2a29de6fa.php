                    ...
                    >
                        <div class="card-body">
                            ...
                            <p class="card-text mb-1 text-primary">
                                ...
                                R$ <?php echo e(number_format($produto->preco_medio_compra, 2, ',', '.')); ?>
                            ...
                            <p class="card-text mb-1">
                                ...
                                <?php echo e($produto->lotes->sum('quantidade_disponivel')); ?>
                            ...
                            <p class="card-text mb-1"><strong>Compra:</strong> 
                                <?php echo e(\Carbon\Carbon::parse($produto->data_compra)->format('d/m/Y')); ?>
                            ...
                            <p class="card-text mb-1 text-primary">
                                ...
                                <?php if($produto->lotes->count() > 0): ?>
                                    <?php echo e($produto->lotes->min('validade_lote')->format('d/m/Y')); ?>
                            ...
                            <div class="d-flex flex-wrap gap-1 mt-3">
                                <div>
                                    <?php if($produto->imagem): ?>
                                        ...
                                        <img 
                                            id="imagemPreview" 
                                            src="<?php echo e(asset('storage/'.$produto->imagem)); ?>" 
                                            alt="Imagem Atual" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\deposito_materiais\resources\views/produtos/index.blade.php ENDPATH**/ ?>