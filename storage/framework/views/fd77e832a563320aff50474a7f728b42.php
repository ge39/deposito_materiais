...
<div class="container d-flex align-items-center justify-content-center bg-light mt-5px"  style="min-height: 100vh;margin-top: -60px;">
    <div class="caixa-card">
        ...
        <?php if(session('warning')): ?>
            <div class="alert alert-warning text-start mb-4" style="border-radius: 8px;">
        ...
        <form method="POST" action="<?php echo e(route('caixa.store')); ?>">
            ...
            <form method="POST" action="<?php echo e(route('caixa.store')); ?>">
                ...
                <div class="mb-5">
                    ...
                    <div class="mb-4">
                        <label class="caixa-label">Terminal-<?php echo e($terminal->nome ?? $terminal->id ?? 'Terminal não identificado'); ?></label>
                        <input type="text"
                ...
                <div class="mb-5">
                    ...
                    <!-- <div class="mb-4">
                        ...
                        <input type="text"
                            class="form-control bg-light"
                            value="R$ <?php echo e(number_format($ultimoCaixa->valor_fechamento ?? 0, 2, ',', '.')); ?>"
                            readonly>
                    </div> -->
                ...
                <input type="hidden" name="empresa_id" value="<?php echo e(auth()->user()->empresa_id); ?>"> 
                ...
                <input type="hidden" name="valor_fundo_anterior" value="<?php echo e($ultimoCaixa->valor_fechamento ?? 0); ?>"> 
                
                
                <div class="d-grid mt-0 top mt-3">
