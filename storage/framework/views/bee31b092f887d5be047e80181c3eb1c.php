    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4">
            <div class="card p-2">
                ...
                <strong>Total Sangria:</strong> <span> R$ <?php echo e(number_format($total_sangrias, 2, ',', '.')); ?></span>
                <strong>Total  Esperado Dinheiro:</strong> R$ <?php echo e(number_format($caixa->fundo_troco + ($totaisPorForma['dinheiro'] ?? 0) - $total_saidas, 2, ',', '.')); ?><br>
