    ...
    <form action="<?php echo e(route('produtos.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                ...
                <input list="listaProdutos" class="form-control" id="nome" name="nome"
                       value="<?php echo e(old('nome')); ?>" placeholder="Digite ou selecione" required>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="codigo_barras"
                       name="codigo_barras" value="<?php echo e(old('codigo_barras')); ?>">
            </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control"
                       name="descricao" required value="<?php echo e(old('descricao')); ?>">
            </div>
        </div>
                ...
                <select class="form-select" id="fornecedor_id" name="fornecedor_id" required>
                    ...
                    <?php $__currentLoopData = $fornecedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fornecedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($fornecedor->id); ?>"
                            <?php echo e(old('fornecedor_id') == $fornecedor->id ? 'selected' : ''); ?>>
            ...
            <div class="col-md-3">
                ...
                <select class="form-select" id="unidade_medida_id" name="unidade_medida_id" required>
                    ...
                    <?php $__currentLoopData = $unidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unidade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($unidade->id); ?>"
                            <?php echo e(old('unidade_medida_id') == $unidade->id ? 'selected' : ''); ?>>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="preco_venda"
                            name="preco_venda" value="<?php echo e(old('preco_venda', 0.00)); ?>">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="preco_custo"
                            name="preco_custo" value="<?php echo e(old('preco_custo', 0.00)); ?>" required>
                    </div>

                    <div class="col-md-3">
                        <label for="data_compra" class="form-label">Data da Compra</label>
                        <input type="date" class="form-control" id="data_compra" name="data_compra"
                            value="<?php echo e(old('data_compra', date('Y-m-d'))); ?>" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="validade_produto" name="validade_produto"
                            value="<?php echo e(old('validade_produto', \Carbon\Carbon::now()->addDays(30)->format('Y-m-d'))); ?>" required>
                    </div>
                    ...
                    <div class="col-md-3"> 
                        <div class="form-group">
                                ...
                                <select name="controla_validade" id="controla_validade" class="form-control">
                                    <option value="1" <?php echo e(old('controla_validade', $produto->controla_validade ?? 1) == 1 ? 'selected' : ''); ?>>Sim</option>
                                    <option value="0" <?php echo e(old('controla_validade', $produto->controla_validade ?? 1) == 0 ? 'selected' : ''); ?>>Não</option>
                                </select>
                            </div>  
                    </div>
            ...
            <div class="col-md-4 d-flex flex-column align-items-center text-center">
                ...
                <div style="
                    ...
                    <img id="imagemPreview" 
                        src="<?php echo e(asset('img/placeholder.png')); ?>" 
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3">
                ...
                <input type="number" step="0.01" class="form-control" name="peso" value="<?php echo e(old('peso')); ?>">
            </div>

            <div class="col-md-3">
                <label class="form-label">Largura (m)</label>
                <input type="number" step="0.01" class="form-control" name="largura" value="<?php echo e(old('largura')); ?>">
            </div>

            <div class="col-md-3">
                <label class="form-label">Altura (m)</label>
                <input type="number" step="0.01" class="form-control" name="altura" value="<?php echo e(old('altura')); ?>">
            </div>

            <div class="col-md-3">
                <label class="form-label">Profundidade (m)</label>
                <input type="number" step="0.01" class="form-control" name="profundidade" value="<?php echo e(old('profundidade')); ?>">
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="localizacao_estoque"
                       value="<?php echo e(old('localizacao_estoque')); ?>">
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\deposito_materiais\resources\views/produtos/create.blade.php ENDPATH**/ ?>