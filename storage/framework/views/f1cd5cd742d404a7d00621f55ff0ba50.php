    ...
    <div class="card shadow-sm mb-4 border-left border-warning">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('fechamento.ajustar', $caixa->id)); ?>" method="POST">
                ...
                <?php $__currentLoopData = $totaisPorForma; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forma => $valorSistema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row row-forma align-items-center mb-3 p-2 border rounded bg-light">
                        ...
                        <div class="col-2 <?php echo e($dif == 0 ? 'text-success' : 'text-danger'); ?> font-weight-bold diferenca">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\deposito_materiais\resources\views/fechamento_caixa/corrigir_divergencias.blade.php ENDPATH**/ ?>