...
<div id="modalBloquearCaixa" style="display: <?php echo e(($caixaBloqueado ?? false) ? 'block' : 'none'); ?>;">
    <div class="carimbo-caixa" >
        ...
        " style="padding: 5px 10px; border-radius: 5px; font-size: 30px; font-weight: bold;  text-align: center; display: inline-block">
            <?php if(isset($bloquearPorTempo) && $bloquearPorTempo): ?>
                TURNO EXPIRADO
                <p style="color: red;"> Caixa <?php echo e($caixa_id); ?>, Aberto(+12H)</p>
                 <p style="color: gray;font-size: 14px;"> Operador: <?php echo e($operador); ?></p>
            <?php else: ?>
