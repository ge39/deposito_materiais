...
<div class="container">
    ...
    <form action="{{ route('rastreio.buscar') }}" method="GET" class="mb-4">
        <div class="row g-4">
            <div class="col-md-3">
                <label>Venda</label>
            ...
            <div class="col-12 d-flex justify-content-end gap-2 mt-2">
                ...
                <a href="{{ route('rastreio.index') }}" class="btn btn-secondary">Limpar</a>
            </div>
        </div>
    </form>
    ...
    @else
        <div  class="card mt-4  alert alert-warning text-center py-3" style="background-color: #f5f1e6;">
            <div class="card-body">
