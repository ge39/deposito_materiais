...
<div class="container">
    ...
    <div class="card p-3">
        ...
        <p><strong>Criado em:</strong> {{ $fornecedor->created_at ? $fornecedor->created_at->format('d/m/Y H:i') : '-' }}</p>
        <p><strong>Atualizado em:</strong> {{ $fornecedor->updated_at ? $fornecedor->updated_at->format('d/m/Y H:i') : '-' }}</p>
    </div>
