...
<div class="container-fluid px-2 romaneio-show">
    ...
    @if($statusNormalizado === 'cancelado')
        <div class="alert alert-danger">
            ...
            @if($romaneio->cancelado_em)
                <div class="small mt-1">
                    Cancelado em:
                    {{ $formatarDataHora($romaneio->cancelado_em) }}

                    @if($resolverNome($romaneio->cancelador))
                        por {{ $resolverNome($romaneio->cancelador) }}
                    @endif
                </div>
            @endif
        </div>
            ...
            <div class="card shadow-sm border-start border-warning border-4 h-100 kpi-card">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3>{{ $itensSeparados }}</h3>

                        <div class="linha-secundaria">
                            Conferidos: {{ $itensConferidosSeparacao }}
                        </div>
                    </div>
            ...
            <div class="card shadow-sm border-start border-info border-4 h-100 kpi-card">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="linha-secundaria">
                            Conf. saída: {{ $itensConferidosSaida }}
                        </div>
                    </div>
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-1">
                ...
                <span>
                    {{ number_format($percentualFluxo, 0, ',', '.') }}%
                </span>
            </div>
            ...
            <div class="progress" style="height: 14px;">
                <div class="progress-bar"
                     role="progressbar"
                     style="width: {{ min($percentualFluxo, 100) }}%;">
                    {{ number_format($percentualFluxo, 0, ',', '.') }}%
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="info-value">
                                {{ $resolverNome($romaneio->motorista)
                                    ?? 'Não definido' }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="info-value">
                                {{ $resolverNome($romaneio->carregador)
                                    ?? 'Não definido' }}
                            </div>
                        </div>
                            ...
                            @if($totalItens > 0)
                                <tfoot class="table-light fw-bold">
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            {{ number_format($totalSeparado, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalConferidoSeparacao, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalCarregado, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalConferidoSaida, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalEntregue, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalDevolvido, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalRecusado, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalAvariado, 2, ',', '.') }}
                                        </td>

                                        <td class="text-end">
                                            {{ number_format($totalPerdido, 2, ',', '.') }}
                                        </td>
                        ...
                        <div class="card ocorrencia-card mb-2">
                            <div class="card-body py-2">
                                ...
                                <div class="linha-secundaria mt-2">
                                    ...
                                    @if($ocorrencia->anexos?->count())
                                        ·
                                        {{ $ocorrencia->anexos->count() }}
                                        anexo(s)
                                    @endif
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="timeline-operacional">
                        ...
                        @foreach($etapasFluxo as $etapa)
                            ...
                            <div class="timeline-etapa {{ $classeEtapa }}">
                ...
                <div class="card-body">
                    @forelse($eventos as $evento)
                        <div class="evento-item mb-2">
                            ...
                            <div class="linha-secundaria">
                                Responsável:
                                {{ $resolverNome($evento->funcionario)
