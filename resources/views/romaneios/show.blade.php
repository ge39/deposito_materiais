    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1">
                <i class="bi bi-clipboard-check me-2"></i>Romaneio {{ $codigo }}
            </h3>
        ...
        <div class="d-flex gap-2">
            ...
            @if(Route::has('romaneios.print'))
                <a href="{{ route('romaneios.print', $romaneio->id) }}" target="_blank" class="btn btn-outline-dark">
                    <i class="bi bi-printer me-1"></i> Imprimir
                </a>
            @endif

            @if(Route::has('expedicao.show'))
                <a href="{{ route('expedicao.show', $romaneio->id) }}" class="btn btn-success">
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h5 class="fw-bold mb-0">
                            <span class="badge bg-{{ $badgeStatus }}">{{ $status }}</span>
                        </h5>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100 border-start border-info border-4">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0">{{ $totalItens }}</h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100 border-start border-success border-4">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0">{{ $itensCarregados }}</h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100 border-start border-warning border-4">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0">{{ number_format($percentual, 0, ',', '.') }}%</h3>
                    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="fw-bold">
                                {{ $entrega ? '#' . $entrega->id : 'Não vinculada' }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="fw-bold">
                                {{ $orcamento ? '#' . $orcamento->id : ($entrega->orcamento_id ?? '—') }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="fw-bold">
                                {{ $venda ? '#' . $venda->id : ($entrega->venda_id ?? '—') }}
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="fw-semibold">
                                {{ $romaneio->observacao ?? 'Nenhuma observação registrada.' }}
                            </div>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="fw-bold mb-3">
                        {{ $entrega->cliente_nome ?? $entrega->nome_cliente ?? $orcamento->cliente->nome ?? 'Cliente não informado' }}
                    </div>
                    ...
                    <div class="fw-semibold mb-3">
                        {{ optional($entrega->data_prevista_entrega ?? null)->format('d/m/Y') ?? ($entrega->data_prevista_entrega ?? 'Não informada') }}
