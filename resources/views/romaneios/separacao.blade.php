...
<head>
    ...
    <title>{{ $tituloDocumento }} - {{ $codigoRomaneio }}</title>
        ...
        <div class="cabecalho">
            ...
            <div class="grid grid-4" style="margin-top: 7px;">
                <div class="campo">
                    ...
                    <span class="valor">{{ $codigoRomaneio }}</span>
                </div>

                <div class="campo">
                    <span class="rotulo">Status</span>
                    <span class="valor">{{ $statusFormatado }}</span>
                </div>
                ...
                <div class="campo">
                    ...
                    <span class="valor">{{ $indexVia + 1 }} de {{ count($vias) }}</span>
                </div>
            </div>
        </div>

        @if($documentoSeparacao)
        ...
        <div class="box">
            ...
            <div class="grid grid-4">
                <div class="campo">
                    ...
                    <span class="valor">{{ $entrega?->codigo_entrega ?? ($entrega ? 'ENT-' . $entrega->id : '—') }}</span>
                </div>

                <div class="campo">
                    <span class="rotulo">Venda</span>
                    <span class="valor">{{ $entrega?->venda_id ? 'VEN-' . $entrega->venda_id : '—' }}</span>
                </div>
            ...
            <div class="grid grid-4" style="margin-top: 6px;">
                <div class="campo">
                    ...
                    <span class="valor">{{ $orcamento?->status ?? '—' }}</span>
                </div>

                <div class="campo">
                    <span class="rotulo">Tipo de entrega</span>
                    <span class="valor">{{ $orcamento?->tipo_entrega ?? $entrega?->tipo_entrega ?? '—' }}</span>
                </div>
        ...
        <div class="box">
            ...
            <div class="grid grid-3">
                <div class="campo">
                    ...
                    <span class="valor">{{ $cliente?->nome ?? 'Cliente não informado' }}</span>
                </div>
                ...
                <div class="campo">
                    ...
                    <span class="valor">{{ $telefoneCliente }}</span>
                </div>
            </div>
            ...
            <div class="grid grid-3" style="margin-top: 6px;">
                <div class="campo" style="grid-column: span 2;">
                    ...
                    <span class="valor">{{ $enderecoEntrega }}</span>
                </div>

                <div class="campo">
                    <span class="rotulo">Responsável pelo recebimento</span>
                    <span class="valor">{{ $entrega?->responsavel_recebimento ?? 'Não informado' }}</span>
                </div>
            </div>
            ...
            <div class="grid grid-3" style="margin-top: 6px;">
                ...
                <div class="campo">
                    ...
                    <span class="valor">{{ $entrega?->periodo_entrega ?? 'Não informado' }}</span>
                </div>

                <div class="campo">
                    <span class="rotulo">Contato no recebimento</span>
                    <span class="valor">{{ $entrega?->telefone_recebimento ?? $telefoneCliente }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="grid grid-2">
                <div class="campo">
                    ...
                    <div class="texto-observacao">{{ $observacaoOrcamento }}</div>
                </div>
                    ...
                    @forelse($romaneio->itens as $i => $item)
                        ...
                        <tr>
                            ...
                            <td class="campo-manual text-center">
                                @if(!$documentoSeparacao && $quantidadeSeparada > 0)
                                    {{ number_format($quantidadeSeparada, 2, ',', '.') }}
                                @endif
                            </td>

                            <td class="campo-manual text-center">
                                @if(!$documentoSeparacao && $divergenciaRegistrada > 0)
                                    {{ number_format($divergenciaRegistrada, 2, ',', '.') }}
                                @endif
                            </td>

                            <td class="campo-manual text-center">
                                @if(!$documentoSeparacao && $quantidadeConferida > 0)
                                    {{ number_format($quantidadeConferida, 2, ',', '.') }}
                                @endif
                            </td>
            ...
            <div class="box">
                ...
                <div class="grid grid-4">
                    ...
                    <div class="campo">
                        ...
                        <span class="valor">
                            {{ optional($romaneio->data_inicio_carregamento)->format('d/m/Y H:i') ?? '—' }}
                        </span>
                    </div>
                    ...
                    <div class="campo">
                        ...
                        <span class="valor">
                            {{ optional($romaneio->data_saida)->format('d/m/Y H:i') ?? '—' }}
                        </span>
                    </div>
                </div>
            </div>
