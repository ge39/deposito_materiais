                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">
                                {{ $entregasDisponiveis->where('status', 'Separando')->count() }}
                            </h3>
                        </div>
            ...
            <div class="card-header operational-table-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <span class="badge bg-light text-dark">
                        Total: {{ $entregasDisponiveis->count() }}
                    </span>
                    <span class="badge bg-warning text-dark">
                        Separando: {{ $entregasDisponiveis->where('status', 'Separando')->count() }}
                    </span>
    ...
    <tbody>
        @forelse($entregasDisponiveis as $entrega)
            ...
            <tr data-status="{{ $status }}"
                ...
                <td>
                    <span class="fw-bold">{{ $entrega->codigo_entrega ?? 'Sem código' }}</span>
                </td>

                <td class="text-center">
                    <span class="fw-semibold">{{ $entrega->venda_id ?? '-' }}</span>
                </td>

                <td class="text-center">
                    <span class="fw-semibold">{{ $entrega->orcamento_id ?? '-' }}</span>
                </td>
                ...
                <td>
                    ...
                    <small class="text-muted">
                        {{ $entrega->orcamento->cliente->telefone ?? 'Telefone não informado' }}
                    </small>
                </td>
