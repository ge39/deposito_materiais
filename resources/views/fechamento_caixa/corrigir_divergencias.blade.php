...
<div class="container-fluid">
    ...
    {{-- ===================== BLOCO 4: GRUPO 1 - HISTÓRICO OPERACIONAL ===================== --}}
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        @foreach($movimentacoesOperacionais as $mov)
                            @php
                    ...
                    <tfoot class="bg-light font-weight-bold border-top">
                        <tr>
                            ...
                            <td class="text-success font-weight-bold py-2" style="font-size: 1.05rem;">
                                R$ {{ number_format($totalGeralVendas, 2, ',', '.') }}
                            </td>
    ...
    {{-- ===================== BLOCO 4: GRUPO 2 - LANÇAMENTOS MANUAIS DO FECHAMENTO ===================== --}}
    <div class="card shadow-sm border-left border-warning">
        <div class="card-header bg-warning text-dark font-weight-bold">
            ⚠️ LANÇAMENTO MANUAL DE FECHAMENTO DO CAIXA #{{ $caixa->id }}
        </div>
        ...
        <div class="card-body p-0">
            <div class="p-3 bg-white border-bottom text-dark" style="font-size: 0.95rem; background-color: #fffdf5 !important;">
                ...
                <strong>Colaborador ({{ $caixa->funcionario->nome ?? 'Operador do Caixa' }})</strong>. Eles representam a contagem física declarada da gaveta.
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        @if($lancamentosFechamento->isEmpty())
                            <tr>
                        ...
                        @else
                            @foreach($lancamentosFechamento as $mov)
                                <tr class="table-info align-middle" style="border-left: 4px solid #0dcaf0;">
                                    ...
                                    <td title="{{ $mov->observacao }}" class="text-dark font-weight-bold" style="max-width: 250px;">
                                        📌 {{ $mov->observacao ?? '-' }}
                                    </td>
                                </tr>
                            @endforeach
