            ...
            <form action="{{ route('produtos.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="localizacao_estoque" name="localizacao_estoque" placeholder="Ex: Corredor B - Prateleira 4" value="{{ old('localizacao_estoque') }}">
                    </div>
                    <div class="col-md-3">
