        ...
        <form method="POST" action="{{ route('caixa.store') }}">
            ...
            <form method="POST" action="{{ route('caixa.store') }}">
                ...
                <div class="mb-5">
                    ...
                    <div class="mb-4">
                        <label class="caixa-label">Terminal-{{ $terminal->nome ?? $terminal->id ?? 'Terminal não identificado' }}</label>
                        <input type="text"
                ...
                <input type="hidden" name="valor_fundo_anterior" value="{{ $ultimoCaixa->valor_fechamento ?? 0 }}"> 
